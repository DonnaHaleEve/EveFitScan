...
namespace DBConverter
{
    partial class Program
    {
        struct ShipDescription
        {
            ...
            {
                file.WriteLine("          m_ShipDescriptions.Add(new ShipDescription(\"{0}\",{1},{2},{3},{4},{5},{6:f4}f,{7:f4}f,{8:f4}f,{9:f4}f,{10:f4}f,{11:f4}f,{12:f4}f,{13:f4}f,{14:f4}f,{15:f4}f,{16:f4}f,{17:f4}f,{18:f4}f,{19:f4}f,{20:f4}f,{21:f4}f,{22:f4}f,{23:f4}f));",
